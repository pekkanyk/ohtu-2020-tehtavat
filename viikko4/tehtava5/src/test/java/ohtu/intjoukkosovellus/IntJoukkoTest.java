...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.onkoJoTaulussa(10));
        assertFalse(joukko.onkoJoTaulussa(5));
        assertTrue(joukko.onkoJoTaulussa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.onkoJoTaulussa(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.onkoJoTaulussa(11));
        joukko.poista(11);
        assertFalse(joukko.onkoJoTaulussa(11));
